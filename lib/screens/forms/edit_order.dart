...
import 'package:portoli/bloc/forms/edit_order.dart';
...
class EditOrderForm extends StatelessWidget {
  final PortfolioEntity portfolio;
  final Orders order;
  const EditOrderForm({Key key, this.portfolio, this.order}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return BlocProvider<EditOrderFormBloc>(
      create: (context) => EditOrderFormBloc(this.portfolio, this.order, context),
      child: Builder(
        builder: (context) {
          final formBloc = BlocProvider.of<EditOrderFormBloc>(context);
          final _drawerBloc = BlocProvider.of<NavDrawerBloc>(context);
          DateTime currentTime = DateTime.now();
          return Scaffold(
            body: FormBlocListener<EditOrderFormBloc, String, String>(
